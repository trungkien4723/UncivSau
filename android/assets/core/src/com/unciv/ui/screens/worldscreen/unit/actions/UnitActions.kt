...
object UnitActions {
    ...
    private val actionTypeToFunctions = linkedMapOf<UnitActionType, (unit: MapUnit, tile: Tile) -> Sequence<UnitAction>>(
        ...
        UnitActionType.FormFleet to UnitActionsCombine::getFormFleetActions,
        UnitActionType.FormArmada to UnitActionsCombine::getFormArmadaActions,
        UnitActionType.PerformRockBand to UnitActionsFromUniques::getPerformRockBandActions,
