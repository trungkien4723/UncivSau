...
interface ICombatant {
    ...
    @Readonly fun getAttackingStrength(defender: ICombatant? = null, combatAction: CombatAction = CombatAction.Attack): Int
    @Readonly fun getDefendingStrength(attacker: ICombatant? = null, combatAction: CombatAction = CombatAction.Defend): Int
