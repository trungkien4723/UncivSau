...
enum class CasusBelli(
    ...
    SurpriseWar("Surprise War", 100, 100, { _, _ -> true }) {
    ...
    FormalWar("Formal War", 75, 75, { attacker, defender -> attacker.diplomacyFunctions.canDeclareFormalWar(defender) }) {
    ...
    HolyWar("Holy War", 50, 50, { attacker, defender -> attacker.diplomacyFunctions.canDeclareHolyWar(defender) }) {
    ...
    LiberationWar("Liberation War", 25, 25, { attacker, defender -> attacker.diplomacyFunctions.canDeclareLiberationWar(defender) }) {
    ...
    ReconquestWar("Reconquest War", 50, 50, { attacker, defender -> attacker.diplomacyFunctions.canDeclareReconquestWar(defender) }) {
    ...
    ProtectorateWar("Protectorate War", 0, 0, { attacker, defender -> attacker.diplomacyFunctions.canDeclareProtectorateWar(defender) }) {
    ...
    ColonialWar("Colonial War", 50, 50, { attacker, defender -> attacker.diplomacyFunctions.canDeclareColonialWar(defender) }) {
