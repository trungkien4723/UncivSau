...
class StatsOverviewTab(
    ...
    private fun updateGreatPeopleTable() = greatPeopleTable.apply {
        ...
        val greatAdmiralPoints = viewingPlayer.greatPeople.greatAdmiralPointsCounter
        val pointsForNextGreatAdmiral = viewingPlayer.greatPeople.pointsForNextGreatAdmiralCounter
        for ((unit, points) in greatAdmiralPoints) {
            val pointsToGreatAdmiral = pointsForNextGreatAdmiral[unit]
            add(unit.toLabel()).left()
            add("$points/$pointsToGreatAdmiral".toLabel())
        }
