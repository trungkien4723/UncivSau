...
In addition, you can keep track of requests, bugs, and our todo list for the application at the repository's [Issue Tracker](https://github.com/trungkien4723/UncivSau/issues)
...
If not, you can still help by spreading the word - vote for UncivSau where you can, mention it on Reddit or Twitter etc, and help us with new ideas of how to get the word out!